...
# Create the FastAPI app with the MCP lifespan
...
async def entity_action(entity_id: str, action: str, params_json: str = "{}") -> dict:
    ...
    Examples:
        entity_id="light.living_room", action="on", params_json='{"brightness": 255}'
        entity_id="switch.garden_lights", action="off"
        entity_id="climate.living_room", action="on", params_json='{"temperature": 22.5}'
    """
...
async def call_service_tool(domain: str, service: str, data_json: str = "{}") -> Dict[str, Any]:
    ...
    Examples:
        domain='light', service='turn_on', data_json='{"entity_id": "light.x", "brightness": 255}'
        domain='automation', service='reload'
        domain='fan', service='set_percentage', data_json='{"entity_id": "fan.x", "percentage": 50}'
